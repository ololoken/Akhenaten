...
namespace
{
	...
	*/
	...
	{
		unsigned int atlasSize = 8; // Start with 128x128
		if (fit) {
	...
	Atlas::Atlas(std::span<const uint8_t> fontData, int fontSize, const Charset& charset, RenderMode mode, int padding, bool fit)
